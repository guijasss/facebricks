...
* Modelo analítico (metrics)
* Modelo de grafo (lineage)

---

# 🎯 Posicionamento do Produto

Não é apenas observabilidade.

É:

> **“Intelligence Layer for Data Platforms”**

ou

> **“Observability + FinOps + Optimization for Databricks”**
...
1. Definir modelo de dados (jobs, runs, custos)
2. Criar pipeline de ingestão (logs + APIs)
3. Implementar primeiros insights (v1)
4. Evoluir para heurísticas (v2)
